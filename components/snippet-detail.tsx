      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
        <div className="min-w-0 space-y-6">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground text-pretty">{snippet.description}</p>
          </div>

          <div className="flex items-center justify-between">
            <h2 className="text-sm font-medium text-muted-foreground">
              {mode === "review" ? "Cliquez sur le + sur n'importe quelle ligne pour commenter" : "Code source"}
            </h2>
            {mode === "view" ? (
              canReview ? (
        ...
        <aside className="space-y-4">
          {mode === "review" ? (
            ...
            <>
              <Card className="p-5">
                <h3 className="text-sm font-semibold">Auteur</h3>
                <div className="mt-3 flex items-center gap-3">
                  <UserAvatar name={snippet.isAnonymous ? "Anonyme" : snippet.author.name} className="size-10" />
                  <div>
